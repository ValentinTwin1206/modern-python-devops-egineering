...
- Section 02: Python 2.3 and metadata-only dependency hints
- Section 03: Python 2.4 and early `setuptools`
- Section 04: Python 2.7 with pinned requirements files
- Section 05: Python 3.5 with `setup.cfg`
- Section 06: Python 3.11 with `pyproject.toml`
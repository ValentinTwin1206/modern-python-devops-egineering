...
|---------|---------|---------|
| [Section 01](./section-01.md) | Python system environment | Journal Admin (CLI) |
| [Section 02](./section-02.md) | Python `venv` environment | Tiny Webserver (Web Server) |
| [Section 03](./section-03.md) | Python Conda environment | Image Processor (Conda Package) |
| [Section 04](./section-04.md) | Python Dev Containers | Pixelpack (Binary) |

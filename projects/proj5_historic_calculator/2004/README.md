...
```sh
../../build.sh build --path proj5_historic_calculator/2004/Dockerfile.devEnv --build-only
```

Open an interactive shell in the development image:

```sh
../../build.sh build --path proj5_historic_calculator/2004/Dockerfile.devEnv
```

Build and run the deployment image:

```sh
../../build.sh build --path proj5_historic_calculator/2004/Dockerfile
```

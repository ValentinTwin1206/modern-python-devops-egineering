...
```sh
../../build.sh build --path proj6_historic_calculator/2010/Dockerfile.devEnv --build-only
```

Open an interactive shell in the development image:

```sh
../../build.sh build --path proj6_historic_calculator/2010/Dockerfile.devEnv
```

Build and run the deployment image:

```sh
../../build.sh build --path proj6_historic_calculator/2010/Dockerfile
```

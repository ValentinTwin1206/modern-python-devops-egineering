...
To freeze the current environment's exact versions back into a file:
...
You should see `Hello from venv environment`.
...
- **No lockfile** — `requirements.txt` only pins what you put in it,
  not the full resolved tree of indirect dependencies.

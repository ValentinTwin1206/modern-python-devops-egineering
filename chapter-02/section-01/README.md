...
The `Dockerfile` is the important system-level demonstration. It
inspects a real Ubuntu-based Python installation:

- It starts from `ubuntu:26.04`
...
```sh
docker build -t py-sys-env chapter-02/section-01
docker run --rm -it -v "$PWD/chapter-02/section-01:/app" py-sys-env
```
...
- **User-installed packages** live under
  ...
  `/root/.local/lib/python3.14/site-packages/` and exposes the `karva`
...
sys.path = [
  ...
  '/root/.local/lib/python3.14/site-packages',
  '/usr/local/lib/python3.14/dist-packages',
    '/usr/lib/python3/dist-packages',
]
USER_BASE: '/root/.local' (exists)
USER_SITE: '/root/.local/lib/python3.14/site-packages' (exists)
...
purelib = /usr/local/lib/python3.14/dist-packages
platlib = /usr/local/lib/python3.14/dist-packages
...
```text
bottle = /usr/local/lib/python3.14/dist-packages/bottle.py
```
...
```text
karva = /root/.local/lib/python3.14/site-packages/karva/__init__.py
ruff = /root/.local/lib/python3.14/site-packages/ruff/__init__.py
